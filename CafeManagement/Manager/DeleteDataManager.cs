...
namespace Coffe_ManagementConsole.CafeManagement.Manager
{
    ...
    {
        public async Task DeleteDataManagerFromConsoleAsync()
        {
            managerModel dataToDelete = GetDeleteDataFromConsole();
        ...
        static managerModel GetDeleteDataFromConsole()
        {
        ...
        static async Task DeleteDataInMySQLApi(managerModel dataToDelete)
        {
            // API endpoint for deleting data 
            string apiUrl = "http://localhost:3000/api/manager2";
