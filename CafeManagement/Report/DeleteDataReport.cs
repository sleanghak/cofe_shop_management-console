...
{
    class DeleteDataReport
    {
        public async Task DeleteDataReportFromConsoleAsync()
        {
            reportModel dataToDelete = GetDeleteDataFromConsole();
        ...
        static reportModel GetDeleteDataFromConsole()
        {
        ...
        static async Task DeleteDataInMySQLApi(reportModel dataToDelete)
        {
            // API endpoint for deleting data 
            string apiUrl = "http://localhost:3000/api/report2";
