...
{
    class DeleteCafeShop
    {

        public async Task DeleteDataFromMySQLAsync()
        {
            cafeshopModel dataToDelete = GetDeleteDataFromConsole();
        ...
        static cafeshopModel GetDeleteDataFromConsole()
        {
        ...
        static async Task DeleteDataInMySQLApi(cafeshopModel dataToDelete)
        {
            // API endpoint for deleting data 
            string apiUrl = "http://localhost:3000/api/cafeshop2";
